...
public class ClusterOperatorConfigTest {
    ...
    static {
        ...
        ENV_VARS.put(ClusterOperatorConfig.ENTITY_WATCHED_NAMESPACE_ENABLED.key(), "true");
    }
    ...
    public void testDefaultConfig() {
        ...
        envVars.remove(ClusterOperatorConfig.ENTITY_WATCHED_NAMESPACE_ENABLED.key());
        ...
        assertThat(config.isEntityWatchedNamespaceEnabled(), is(false));
    }
    ...
    public void testEnvVars() {
        ...
        assertThat(config.isEntityWatchedNamespaceEnabled(), is(true));
    }
